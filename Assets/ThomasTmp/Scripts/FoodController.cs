...
public class FoodController : MonoBehaviour
{
    ...
    void Update()
    {
        // Faire spawner de la nourriture é intervalles réguliers
    ...
    void SpawnFood()
    {
        // Spawner la nourriture é une position aléatoire dans la scéne
    ...
    // Ajouter dans le GameController ou à appeler depuis celui-ci
